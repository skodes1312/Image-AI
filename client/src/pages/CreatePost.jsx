    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          Create imaginative and visually mesmerizing images with the help of
      ...
      <form className="mt-16 max-w-3xl" onSubmit={submitHandler}>
        <div className="flex flex-col gap-5">
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            ...
            {generatingImg && (
              <div className="absolute inset-0 z-= flex justify-center items-center bg-[rgba(0,0,0,0.5)] rounded-lg">
                <Loader />
              </div>
            )}
          </div>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Don't forget to share your images with others in the Community
          </p>
          <button
            type="submit"
